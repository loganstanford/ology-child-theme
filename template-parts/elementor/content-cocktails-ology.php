...
?>
<style>
h2.ology-cocktails-title,
h2.ology-cocktails-title a {
    color: #031a1d;
    text-align: center;
    margin-bottom: 20px;
    font-size: 26px;
...
<div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
    <div class="progression-studios-beers-index">
        ...
        <div class="progression-beers-content">
            ...
            <h2 class="ology-cocktails-title">
                <?php ology_beers_portfolio_image_link(); ?><?php the_title(); ?><?php if(get_post_meta($post->ID, 'progression_studios_featured_image_link', true) != 'progression_link_none'): ?></a><?php endif; ?>
            </h2>
            ...
            <ul class="beers-availability-list-container">
                <?php
					...
					if ($containers) {
						?><li class="beers-availability-list text-nowrap">Available in</li><?php
						foreach ($containers[0] as $size) {
							?><li class="beers-availability-list text-nowrap"><?php echo $size;?></li><?php
						}
					}
					?>
            </ul>
            ...
            <?php if(has_excerpt() ): ?>
            <div class="progression-studios-beers-excerpt"><?php the_excerpt(); ?></div>
            <!-- close .progression-studios-beers-excerpt -->
            <?php endif; ?>
            <?php endif; ?>

            <?php if(get_post_meta($post->ID, 'progression_studios_button_text', true)): ?>
            <div class="progression-button-centered">
                <?php progression_studios_portfolio_button_link(); ?><?php echo esc_html( get_post_meta($post->ID, 'progression_studios_button_text', true) );?></a>
            </div>
            <?php endif; ?>
